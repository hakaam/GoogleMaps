...
class _PolylineTwoScreenState extends State<PolylineTwoScreen> {
  ...
  CameraPosition _kGooglePlex =  CameraPosition(
    target: LatLng(31.45190823234587, 74.293659368189),
    zoom: 14,
  );
  static const LatLng _center = const LatLng(31.45190823234587, 74.293659368189);
...
//add your lat and lng where you wants to draw polyline
  ...
  List<LatLng> latlng = [LatLng(31.45190823234587, 74.293659368189) ,
    LatLng(31.464065565190797, 74.44262453260728)];
