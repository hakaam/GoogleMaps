...
class _CustomMarkerWithNetworkImageState extends State<CustomMarkerWithNetworkImage> {
  ...
  List<LatLng> _latLang =  [
    LatLng(31.506432,74.3243776), LatLng(31.4640107,74.4404412) ,LatLng(31.4517298,74.2914814),
    LatLng(31.5800606,74.2862774), LatLng(31.4965253,74.1822978), LatLng(31.2465378,73.8754861)
  ];

  static const CameraPosition _kGooglePlex =  CameraPosition(
    target: LatLng(31.506432,74.3243776),
    zoom: 15,
  );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Custom Marker network images'),
